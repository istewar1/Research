...
class create_n42(object):
    def convert_hdf5(self,full_path_to_input,outPath,start_time=0.0,end_time=1E16):
        ...
        '''
        self.spectra  = hdf5['Det1_Spectra']
        self.time     = hdf5['Det1_Times']
        self.livetime = hdf5['Det1_LiveTimes']
        #
        ...
        #
        f = open(outPath+self.filename, "w+")
        #
        ...
        f.write('<EnergyCalibration id="EnCal9b7996618a05e5a953de0b7345c415f">	<CoefficientValues>0.0 3.0 0.0</CoefficientValues>\n')
...
if __name__ == '__main__':
    #
    full_input_path  = '/Volumes/IAN USB/WIND/GADRAS dat Creation/EBox02-Eu152-2018-12-21T12.29.29.639.hdf5'
    full_output_path = '/Users/i6o/Desktop/'
    ...
    n42.convert_hdf5(full_input_path,full_output_path)